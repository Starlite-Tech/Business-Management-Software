...
description:
  This file currently contains fltk example code. Real Functionality will be added soon.
 */
...
// create a counter Struct which contains all functionality for the counter app.
#[derive(Clone)]
pub struct Counter{
